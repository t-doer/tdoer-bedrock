...
public interface RentalCenter {
    ...
    ProductRental getProductRendtal(Long tenantId, String productId);

    ProductRental[] getProductRendtal(Long tenantId);

    TenantClient getTenantClient(String host);

    TenantClient getTenantClient(Long tenantId, String clientId);
